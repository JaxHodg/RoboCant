...
def createUpdateQuery(tbName, set, condition):
    return ("UPDATE " + tbName + " SET " + set + " WHERE " + condition + ";")

def createUpdateQueryNC(tbName, set):
    return ("UPDATE " + tbName + " SET " + set + ";")

def createInsertQuery(tbName):
    return 1;
